...
export function setPdActiveTab(t) { pdActiveTab = t; }
// 🆕 لازمة لصفحة main.js: showView() يحتاج يغيّر العرض الحالي من خارج هذا الملف،
// وبما إنه ES module فالمتغيرات المستوردة للقراءة فقط، فهذا setter ضروري.
